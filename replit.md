...
**DEPLOYMENT STRATEGY:**
- **Platform**: Native Android/iOS via VoltBuilder cloud compilation
- **Architecture**: Hybrid web-to-native using Capacitor framework
- **Backend Integration**: API calls to live Vercel production deployment
- **Cost Structure**: VoltBuilder $15/month + Apple Developer Program $99/year for iOS
- **Distribution**: Firebase App Distribution for direct installation (no app stores)

**BUILD PIPELINE:**
1. **Source Preparation**: `scripts/build-mobile.sh` creates mobile-specific package
2. **Configuration**: Static export Next.js + Capacitor native bridge
3. **Compilation**: VoltBuilder cloud service compiles to native binaries
4. **Distribution**: Firebase App Distribution or direct APK/IPA delivery

**CURRENT STATUS:**
- **Architecture**: Complete separation between web and mobile builds
- **Configuration**: Platform-specific Next.js configurations implemented
- **Build Scripts**: Automated mobile package generation
- **VoltBuilder Integration**: Ready for cloud compilation
- **Environment Separation**: Strict separation between development, web production, and mobile production

**DEPLOYMENT PACKAGE:**
- **Generated by**: `scripts/build-mobile.sh`
- **Configuration**: Mobile-optimized Next.js static export
- **Backend**: Remote API integration with Vercel deployment
- **Native Features**: Capacitor plugins for device access
