...
export default function AgentCalendar({
  ...
  // Listen for sidebar state changes and force calendar resize
  useEffect(() => {
    const handleResize = () => {
...
Do you want to continue?`;
  ...
  return (
    <div
      className={`${theme === "dark" ? "bg-gray-800 text-white dark" : "bg-white"} rounded-lg shadow p-4 h-full w-full transition-all duration-300 ease-in-out overflow-hidden`}
    >
      {loading && !calendarData.length ? (
        ...
        <div
          className={`${theme === "dark" ? "fc-theme-dark dark" : ""} calendar-container w-full ${sidebarCollapsed ? "sidebar-collapsed" : "sidebar-expanded"}`}
        >
          ...
          <FullCalendar
            ...
            aspectRatio={1.8} // Better default aspect ratio for visibility
