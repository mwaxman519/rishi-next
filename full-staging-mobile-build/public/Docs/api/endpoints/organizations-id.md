# organizations/[id] API Endpoint

## Overview

Workforce management API endpoint for organizations [id] operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/organizations/[id]
```
...
Retrieve organizations [id] data.
...
Create new organizations [id] resource.
...
Update existing organizations [id] resource.
...
Delete organizations [id] resource.
...
- `organizations.[id].created`
- `organizations.[id].updated`
- `organizations.[id].deleted`
