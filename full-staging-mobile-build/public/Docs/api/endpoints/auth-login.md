...
Workforce management API endpoint for auth login operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/auth/login
```
...
Create new auth login resource.
...
Update existing auth login resource.
