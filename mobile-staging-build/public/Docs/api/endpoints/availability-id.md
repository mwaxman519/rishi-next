# availability/[id] API Endpoint

## Overview

Workforce management API endpoint for availability [id] operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/availability/[id]
```
...
Create new availability [id] resource.
...
Update existing availability [id] resource.
...
Delete availability [id] resource.
...
- `availability.[id].created`
- `availability.[id].updated`
- `availability.[id].deleted`
