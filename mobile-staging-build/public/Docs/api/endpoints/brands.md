...
Workforce management API endpoint for brands operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/brands
```
...
Update existing brands resource.
