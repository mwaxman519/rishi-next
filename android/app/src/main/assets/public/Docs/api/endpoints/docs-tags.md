# docs/tags API Endpoint

## Overview

Workforce management API endpoint for docs tags operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/docs/tags
```
...
Update existing docs tags resource.
