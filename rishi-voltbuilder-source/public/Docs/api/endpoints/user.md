...
Workforce management API endpoint for user operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/user
```
...
- **GET**: Read permissions for user
- **POST**: Create permissions for user
- **PUT/PATCH**: Update permissions for user
- **DELETE**: Delete permissions for user
