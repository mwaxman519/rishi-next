# auth/permissions API Endpoint

## Overview

Workforce management API endpoint for auth permissions operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/auth/permissions
```
...
Retrieve auth permissions data.
...
Create new auth permissions resource.
...
Update existing auth permissions resource.
...
Delete auth permissions resource.
...
- `auth.permissions.created`
- `auth.permissions.updated`
- `auth.permissions.deleted`
