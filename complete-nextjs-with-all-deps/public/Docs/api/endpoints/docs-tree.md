# docs/tree API Endpoint

## Overview

Workforce management API endpoint for docs tree operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/docs/tree
```
...
Update existing docs tree resource.
