# docs/cached API Endpoint

## Overview

Workforce management API endpoint for docs cached operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/docs/cached
```
...
Create new docs cached resource.
...
Update existing docs cached resource.
