# expenses/summary API Endpoint

## Overview

Workforce management API endpoint for expenses summary operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/expenses/summary
```
...
Retrieve expenses summary data.
...
Create new expenses summary resource.
...
Update existing expenses summary resource.
...
Delete expenses summary resource.
...
- `expenses.summary.updated`
- `expenses.summary.deleted`
