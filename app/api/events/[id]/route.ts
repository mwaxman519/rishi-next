...
// Mock event data (same as in the events route)
const mockEvents = [
  {
    id: "1",
...
export async function PUT(
  ...
  try {
    ...
    // Here you would normally update the event in the database
...
export async function DELETE(
  ...
  try {
    ...
    // Here you would normally update the event status in the database
