...
export async function GET(req: NextRequest): Promise<NextResponse> {
  try {
    ...
    const excludeBrandId = url.(searchParams.get("excludeBrandId") || undefined) || undefined;
    const stateId = url.(searchParams.get("stateId") || undefined) || undefined;
    const searchTerm = url.(searchParams.get("search") || undefined) || undefined;
