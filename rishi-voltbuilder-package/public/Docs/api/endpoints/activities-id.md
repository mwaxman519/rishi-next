# activities/[id] API Endpoint

## Overview

Workforce management API endpoint for activities [id] operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/activities/[id]
```
...
Create new activities [id] resource.
...
Update existing activities [id] resource.
...
- `activities.[id].created`
- `activities.[id].updated`
- `activities.[id].deleted`
