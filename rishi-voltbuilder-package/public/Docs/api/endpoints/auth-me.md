...
Workforce management API endpoint for auth me operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/auth/me
```
...
Update existing auth me resource.
