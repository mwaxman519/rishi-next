# organizations/user API Endpoint

## Overview

Workforce management API endpoint for organizations user operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/organizations/user
```
...
Retrieve organizations user data.
...
Create new organizations user resource.
...
Update existing organizations user resource.
...
Delete organizations user resource.
