...
Workforce management API endpoint for admin organizations operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/admin/organizations
```
...
Retrieve admin organizations data.
...
Create new admin organizations resource.
...
Update existing admin organizations resource.
...
Delete admin organizations resource.
...
- `admin.organizations.created`
- `admin.organizations.updated`
- `admin.organizations.deleted`
