...
Workforce management API endpoint for locations [id] operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/locations/[id]
```
...
Create new locations [id] resource.
...
Update existing locations [id] resource.
