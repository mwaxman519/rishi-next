# users/[id] API Endpoint

## Overview

Workforce management API endpoint for users [id] operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/users/[id]
```
...
Update existing users [id] resource.
