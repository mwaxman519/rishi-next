# docs/init API Endpoint

## Overview

Workforce management API endpoint for docs init operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/docs/init
```
...
Update existing docs init resource.
