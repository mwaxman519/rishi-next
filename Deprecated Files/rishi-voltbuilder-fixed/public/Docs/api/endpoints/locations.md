...
Workforce management API endpoint for locations operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/locations
```
...
Update existing locations resource.
