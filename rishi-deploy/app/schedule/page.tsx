...
export const metadata: Metadata = {
  title: "My Schedule | Rishi Workforce Management",
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Tabs defaultValue="schedule" className="space-y-4">
        ...
        <TabsContent value="availability" className="space-y-4">
          {/* Availability Management with Full Calendar */}
          <Card>
            <CardHeader>
              <CardTitle>Availability Calendar</CardTitle>
              <CardDescription>
                Click and drag to set your availability. Green blocks show when
                you're available, red blocks show when you're unavailable.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="min-h-[600px]">
                <AgentCalendar
                  userId="00000000-0000-0000-0000-000000000001" // Current user ID
                  viewOnly={false}
                  startDate={new Date()}
                  endDate={
