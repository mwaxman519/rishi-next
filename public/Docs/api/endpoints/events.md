...
Workforce management API endpoint for events operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/events
```
...
Update existing events resource.
