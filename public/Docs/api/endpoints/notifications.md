...
Workforce management API endpoint for notifications operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/notifications
```
...
Create new notifications resource.
...
Update existing notifications resource.
