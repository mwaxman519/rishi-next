# bookings/stats API Endpoint

## Overview

Workforce management API endpoint for bookings stats operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/bookings/stats
```
...
Create new bookings stats resource.
...
Update existing bookings stats resource.
...
Delete bookings stats resource.
...
- `bookings.stats.created`
- `bookings.stats.updated`
- `bookings.stats.deleted`
