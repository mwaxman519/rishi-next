# docs/recent API Endpoint

## Overview

Workforce management API endpoint for docs recent operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/docs/recent
```
...
Create new docs recent resource.
...
Update existing docs recent resource.
