# features/manage API Endpoint

## Overview

Workforce management API endpoint for features manage operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/features/manage
```
...
Create new features manage resource.
...
Update existing features manage resource.
...
Delete features manage resource.
...
- `features.manage.created`
- `features.manage.updated`
- `features.manage.deleted`
