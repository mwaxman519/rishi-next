...
Workforce management API endpoint for auth register operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/auth/register
```
...
Create new auth register resource.
...
Update existing auth register resource.
