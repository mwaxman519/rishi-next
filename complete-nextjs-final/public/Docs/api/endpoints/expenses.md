...
Workforce management API endpoint for expenses operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/expenses
```
...
Update existing expenses resource.
