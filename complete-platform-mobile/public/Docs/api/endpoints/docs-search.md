# docs/search API Endpoint

## Overview

Workforce management API endpoint for docs search operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/docs/search
```
...
Create new docs search resource.
...
Update existing docs search resource.
