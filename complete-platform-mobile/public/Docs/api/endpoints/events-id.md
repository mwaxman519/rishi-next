# events/[id] API Endpoint

## Overview

Workforce management API endpoint for events [id] operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/events/[id]
```
...
Update existing events [id] resource.
