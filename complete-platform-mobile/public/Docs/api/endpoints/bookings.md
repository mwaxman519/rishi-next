...
Workforce management API endpoint for bookings operations.

## Base URL

```
https://polite-mud-027da750f.2.azurestaticapps.net/api/bookings
```
...
Update existing bookings resource.
